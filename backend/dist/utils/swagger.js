...
const options = {
    definition: {
        ...
        info: {
            ...
            version: "1.0.0",
            description: "API complète pour la plateforme e-santé CareFlow adaptée au contexte sénégalais",
            contact: {
        ...
        tags: [
            ...
            {
                name: "Referentials",
                description: "APIs des référentiels sénégalais (régions, spécialités, etc.)",
            },
            {
                name: "Establishments",
        ...
        paths: {
            ...
            "/api/referentials/regions": {
                get: {
                    ...
                    description: "Récupère toutes les régions sénégalaises avec informations démographiques",
                    parameters: [
                        {
                            name: "search",
                            in: "query",
                            description: "Recherche textuelle dans nom, capitale ou départements",
                            required: false,
                            schema: { type: "string" },
                        },
                        {
            ...
            "/api/referentials/medical-specialties": {
                get: {
                    ...
                    description: "Liste des spécialités médicales avec tarifs et catégories",
                    responses: {
                        "200": {
            ...
            "/api/referentials/insurance-companies": {
                get: {
                    ...
                    description: "Liste des organismes d'assurance avec filtres par type et région",
                    parameters: [
                        {
                            name: "type",
                            in: "query",
